...
페이지를 index 페이지에서 이뤄지는데

그러면 genre/ < char:book_genre > 

url을 어떻게 다가가야하는가

![image-20210511220808352](README.assets/image-20210511220808352.png)

yes24의 카테고리마다 주어지는 url

그런데 인덱스 페이지에서 endif로 충분이 보여줄수있을거 같은 느낌은 왤까..



분류 탭의 '드라마' 를 누르면 books/genre/ 드라마 로 이동한다.

그런데 나는 장르또한 따로 생성하고 싶다.

그러니 장르들만있는 모델만을 받아서 분류 버튼을 생성해줘야한다.
